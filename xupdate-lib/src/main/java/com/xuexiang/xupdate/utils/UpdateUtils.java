...
public final class UpdateUtils {
     ...
     */
    public static void processUpdateEntity(UpdateEntity updateEntity, @NonNull String result,
            @NonNull IUpdateProxy updateProxy) throws Exception {
        if (updateEntity != null) {
            if (updateEntity.isHasUpdate()) {
                // 校验是否是已忽略版本
                if (updateEntity.isIgnorable()
                        && UpdateUtils.isIgnoreVersion(updateProxy.getContext(), updateEntity.getVersionName())) {
    ...
    public static boolean checkWifi() {
        ConnectivityManager connectivity =
                (ConnectivityManager) XUpdate.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isApkDownloaded(UpdateEntity updateEntity) {
        ...
        return !TextUtils.isEmpty(updateEntity.getMd5()) && FileUtils.isFileExists(appFile)
    ...
    public static File getApkFileByUpdateEntity(UpdateEntity updateEntity) {
        ...
        return new File(updateEntity.getApkCacheDir().concat(File.separator + updateEntity.getVersionName())
    ...
    public static boolean startActivity(final Intent intent) {
        ...
        if (XUpdate.getContext().getPackageManager().resolveActivity(intent,
            ...
            UpdateLog.e("[resolveActivity failed]: "
                    + (intent.getComponent() != null ? intent.getComponent().getClassName() : intent.getAction())
