...
public final class DrawableUtils {
     ...
     * @return 得到空心效果
     */
    public static GradientDrawable getStrokeRectDrawable(int cornerRadius, int solidColor, int strokeColor,
            int strokeWidth) {
        GradientDrawable gradientDrawable = new GradientDrawable();
     ...
     * @return 得到空心效果
     */
    public static GradientDrawable getStrokeRectDrawable(int cornerRadius, int strokeColor, int strokeWidth) {
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setStroke(strokeWidth, strokeColor);
        gradientDrawable.setCornerRadius(cornerRadius);
        gradientDrawable.setGradientType(GradientDrawable.RADIAL_GRADIENT);
     ...
     * @return 状态选择器
     */
    public static StateListDrawable getStateListDrawable(Drawable pressedDrawable, Drawable focusDrawable,
     ...
     * @return 状态选择器
     */
    public static StateListDrawable getDrawable(int cornerRadius, int pressedColor, int focusColor, int normalColor) {
        return getStateListDrawable(getSolidRectDrawable(cornerRadius, pressedColor),
                getStrokeRectDrawable(cornerRadius, focusColor, focusColor, 4),
     ...
     * @return 状态选择器
     */
    public static StateListDrawable getStrokeDrawable(int cornerRadiusPX, int strokeWidthPX, int subColor) {
        // 一般solidColor 为透明
        return getStateListDrawable(
                // 实心
                getStrokeRectDrawable(cornerRadiusPX, Color.TRANSPARENT, subColor, strokeWidthPX),
                // 实心
                getStrokeRectDrawable(cornerRadiusPX, Color.TRANSPARENT, subColor, strokeWidthPX),
                // 空心
                getStrokeRectDrawable(cornerRadiusPX, Color.TRANSPARENT, Color.TRANSPARENT, strokeWidthPX));
    }
     ...
     * @return 状态选择器
     */
    public static StateListDrawable getStrokeSolidDrawable(int cornerRadiusPX, int strokeWidthPX, int subColor,
            int mainColor) {
        // 一般solidColor 为透明
        return getStateListDrawable(
                // 实心
     ...
     * @return 状态选择器
     */
    public static StateListDrawable getSolidStrokeDrawable(int cornerRadiusPX, int strokeWidthPX, int subColor,
            int mainColor) {
        // 一般solidColor 为透明
        return getStateListDrawable(
                // 空心
    ...
    public static StateListDrawable getDrawable(int cornerRadius, int focusColor, int normalColor) {
        return getDrawable(cornerRadius, ColorUtils.colorDeep(normalColor), focusColor, normalColor);
    }
