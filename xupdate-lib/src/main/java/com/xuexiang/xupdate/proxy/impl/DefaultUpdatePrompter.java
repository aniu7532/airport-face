...
public class DefaultUpdatePrompter implements IUpdatePrompter {
    ...
    public void showPrompt(@NonNull UpdateEntity updateEntity, @NonNull IUpdateProxy updateProxy,
            @NonNull PromptEntity promptEntity) {
        ...
        if (context instanceof FragmentActivity) {
            UpdateLog.d("[UpdateDialogFragment] ");
            UpdateDialogFragment.show(((FragmentActivity) context).getSupportFragmentManager(), updateEntity,
                    getPrompterProxy(updateProxy), promptEntity);
        } else if (context instanceof Activity) {
            UpdateLog.d("[UpdateDialog] ");
            UpdateDialog.newInstance(context, updateEntity, getPrompterProxy(updateProxy), promptEntity).show();
        } else {
            UpdateLog.d("[UpdateDialogActivity] ");
