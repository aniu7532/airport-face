    ...
    private UpdateEntity parseDefaultUpperFormatJson(JSONObject jsonObject) throws JSONException {
        ...
        if (code == APIConstant.REQUEST_SUCCESS) {
            ...
            if (updateStatus == APIConstant.NO_NEW_VERSION) {
                ...
                updateEntity.setHasUpdate(true).setUpdateContent(jsonObject.getString(APIKeyUpper.MODIFY_CONTENT))
                        .setVersionCode(versionCode).setVersionName(jsonObject.getString(APIKeyUpper.VERSION_NAME))
    ...
    private UpdateEntity parseDefaultLowerFormatJson(JSONObject jsonObject) throws JSONException {
        ...
        if (code == APIConstant.REQUEST_SUCCESS) {
            ...
            if (updateStatus == APIConstant.NO_NEW_VERSION) {
                ...
                updateEntity.setHasUpdate(true).setUpdateContent(jsonObject.getString(APIKeyLower.MODIFY_CONTENT))
                        .setVersionCode(versionCode).setVersionName(jsonObject.getString(APIKeyLower.VERSION_NAME))
