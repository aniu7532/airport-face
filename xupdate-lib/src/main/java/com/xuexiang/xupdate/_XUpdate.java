...
public final class _XUpdate {
     ...
     */
    public static void startInstallApk(@NonNull Context context, @NonNull File apkFile,
            @NonNull DownloadEntity downloadEntity) {
     ...
     * @param errorCode
     */
    public static void onUpdateError(int errorCode, UpdateEntity updateEntity) {
        onUpdateError(new UpdateError(errorCode, updateEntity));
    }
    ...
    public static void onUpdateError(int errorCode, String message) {
        onUpdateError(new UpdateError(errorCode, message, null));
    }
     ...
     * @param message   错误信息
     */
    public static void onUpdateError(int errorCode, String message, UpdateEntity updateEntity) {
        onUpdateError(new UpdateError(errorCode, message, updateEntity));
    }
