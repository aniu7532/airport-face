...
public class UpdateEntity implements Parcelable {
    ...
    public String toString() {
        return "UpdateEntity{" + "mHasUpdate=" + mHasUpdate + ", mIsForce=" + mIsForce + ", mIsIgnorable="
                + mIsIgnorable + ", mVersionCode=" + mVersionCode + ", mVersionName='" + mVersionName + '\''
                + ", mUpdateContent='" + mUpdateContent + '\'' + ", mDownloadEntity=" + mDownloadEntity + ", mIsSilent="
                + mIsSilent + ", mIsAutoInstall=" + mIsAutoInstall + ", mIUpdateHttpService=" + mIUpdateHttpService
                + '}';
    }
