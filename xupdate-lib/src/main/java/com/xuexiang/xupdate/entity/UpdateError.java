...
public class UpdateError extends Throwable {
    ...
    public UpdateError(int code, UpdateEntity entity) {
        this(code, null, entity);
    }

    public UpdateError(int code, String message, UpdateEntity entity) {
    ...
    public final static class ERROR {
        ...
        public static final int PROMPT_CANCEL = PROMPT_UNKNOWN + 1;
        public static final int PROMPT_IGNORE = PROMPT_CANCEL + 1;
        public static final int PROMPT_ACTIVITY_DESTROY = PROMPT_IGNORE + 1;
    ...
    public static void init(Context context) {
        ...
        sMessages.append(ERROR.CHECK_APK_CACHE_DIR_EMPTY,
                context.getString(R.string.xupdate_error_check_apk_cache_dir_empty));

        sMessages.append(ERROR.PROMPT_UNKNOWN, context.getString(R.string.xupdate_error_prompt_unknown));
        sMessages.append(ERROR.PROMPT_CANCEL, context.getString(R.string.xupdate_error_prompt_cancel));
        sMessages.append(ERROR.PROMPT_IGNORE, context.getString(R.string.xupdate_error_prompt_ignore));

        sMessages.append(ERROR.PROMPT_ACTIVITY_DESTROY,
                context.getString(R.string.xupdate_error_prompt_activity_destroy));

        sMessages.append(ERROR.DOWNLOAD_FAILED, context.getString(R.string.xupdate_error_download_failed));
        sMessages.append(ERROR.DOWNLOAD_PERMISSION_DENIED,
                context.getString(R.string.xupdate_error_download_permission_denied));
