...
public class PromptEntity implements Parcelable {
    ...
    public PromptEntity setLayout(int layout) {
        mLayout = layout;
        return this;
    }
    ...
    public PromptEntity setFocusColor(int focusColor) {
    ...
    public String toString() {
        return "PromptEntity{" + "mThemeColor=" + mThemeColor + ", mFocusColor=" + mFocusColor + ", mTopResId="
                + mTopResId + ", mTopDrawableTag=" + mTopDrawableTag + ", mButtonTextColor=" + mButtonTextColor
                + ", mSupportBackgroundUpdate=" + mSupportBackgroundUpdate + ", mWidthRatio=" + mWidthRatio
                + ", mHeightRatio=" + mHeightRatio + ", mIgnoreDownloadError=" + mIgnoreDownloadError + '}';
    }
