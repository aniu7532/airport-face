...
public class UpdateManager implements IUpdateProxy {
    ...
    public static class Builder {
         ...
         * 自定义Layout
         *
         * @param layout 自定义Layout
         * @return this
         */
        public Builder promptLayout(int layout) {
            promptEntity.setLayout(layout);
            return this;
        }
         ...
         * 设置焦点颜色
         *
         * @param focusColor 焦点颜色资源
         * @return this
         */
        @Deprecated
        public Builder focusColor(@ColorInt int focusColor) {
            promptEntity.setFocusColor(focusColor);
            return this;
        }
         ...
         * @return this
         */
        public Builder promptFocusColor(@ColorInt int focusColor) {
            promptEntity.setFocusColor(focusColor);
            return this;
        }
        ...
        public void update(IUpdateProxy updateProxy) {
            build().setIUpdateProxy(updateProxy).update();
        }
    }
    ...
    public String toString() {
        return "XUpdate{" + "mUpdateUrl='" + mUpdateUrl + '\'' + ", mParams=" + mParams + ", mApkCacheDir='"
                + mApkCacheDir + '\'' + ", mIsWifiOnly=" + mIsWifiOnly + ", mIsGet=" + mIsGet + ", mIsAutoMode="
                + mIsAutoMode + '}';
    }
}
