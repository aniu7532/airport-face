...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener, IDownloadEventHandler {
    public String TAG = "UpdateDialogFragment";
     ...
     */
    public static void show(@NonNull FragmentManager fragmentManager, @NonNull UpdateEntity updateEntity,
            @NonNull IPrompterProxy prompterProxy, @NonNull PromptEntity promptEntity) {
    ...
    public void onStart() {
        ...
        super.onStart();
        // BarUtils.setStatusBarLightMode(getDialog().getWindow(), false);
        // BarUtils.setStatusBarColor(getDialog().getWindow(), Color.TRANSPARENT);
    }

    private void initDialog() {
        UpdateLog.i(TAG + "， initDialog:");
        Dialog dialog = getDialog();
        if (dialog == null) {
            return;
        }
        ...
        // lp.width = (int) (displayMetrics.heightPixels * promptEntity.getWidthRatio());
        // }
        // if (promptEntity.getHeightRatio() > 0 && promptEntity.getHeightRatio() < 1) {
        // lp.height = (int) (displayMetrics.widthPixels * promptEntity.getHeightRatio());
        // }
        // } else if (mCurrentOrientation == ORIENTATION_PORTRAIT) {
        // if (promptEntity.getWidthRatio() > 0 && promptEntity.getWidthRatio() < 1) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        UpdateLog.i(TAG + "， onCreateView:");
        return inflater.inflate(
                (getPromptEntity() != null && getPromptEntity().getLayout() > 0) ? getPromptEntity().getLayout()
                        : R.layout.xupdate_layout_update_prompter,
                container);
    }
    ...
    private void initData() {
        ...
        initTheme(mPromptEntity.getThemeColor(), mPromptEntity.getFocusColor(), mPromptEntity.getTopResId(),
                mPromptEntity.getButtonTextColor());
    ...
    private void initTheme(@ColorInt int themeColor, @ColorInt int focusColor, @DrawableRes int topResId,
        ...
        setDialogTheme(themeColor, focusColor, topResId, buttonTextColor);
    }
     ...
     * @param topResId   图片
     */
    private void setDialogTheme(int themeColor, int focusColor, int topResId, int buttonTextColor) {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CODE_REQUEST_PERMISSIONS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                _XUpdate.onUpdateError(DOWNLOAD_PERMISSION_DENIED, mUpdateEntity);
                dismissDialog();
            }
        }
    ...
    private void onInstallApk() {
        _XUpdate.startInstallApk(getActivity(), UpdateUtils.getApkFileByUpdateEntity(mUpdateEntity),
