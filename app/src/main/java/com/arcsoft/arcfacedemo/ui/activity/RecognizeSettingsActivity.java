...
public class RecognizeSettingsActivity extends BaseActivity {
     ...
     */
    public static class SettingsFragment extends RecognizeSettingsPreferenceFragment
        ...
        /*
         * 用于显示检测角度用的 map，KEY - VALUE如下 ASF_OP_0_ONLY -> 仅0度 .... ASF_OP_ALL_OUT -> 全角度
         */
        ...
        private void initData() {
            ...
            livenessDetectTypeValueArray =
                    getResources().getStringArray(canOpenDualCamera ? R.array.liveness_detect_type_with_ir_values
                            : R.array.liveness_detect_type_no_ir_values);
            livenessDetectTypeArray = getResources().getStringArray(
                    canOpenDualCamera ? R.array.liveness_detect_with_ir_types : R.array.liveness_detect_no_ir_types);
        ...
        private void initPreference() {
            ...
            imageQualityNoMaskRecognizeThresholdPreference =
                    findPreference(getString(R.string.preference_image_quality_no_mask_recognize_threshold));
            imageQualityNoMaskRecognizeThresholdPreference.setOnPreferenceChangeListener(this);

            imageQualityNoMaskRegisterThresholdPreference =
                    findPreference(getString(R.string.preference_image_quality_no_mask_register_threshold));
            imageQualityNoMaskRegisterThresholdPreference.setOnPreferenceChangeListener(this);

            imageQualityMaskRecognizeThresholdPreference =
                    findPreference(getString(R.string.preference_image_quality_mask_recognize_threshold));
            ...
            //
            // String mouthCloseThreshold = String.format("%.2f",
            // ConfigUtil.getRecognizeMouthCloseThreshold(getContext()));
            // mouthCloseThresholdPreference.setText(mouthCloseThreshold);
            //
            // String wearGlassesThreshold = String.format("%.2f",
            // ConfigUtil.getRecognizeWearGlassesThreshold(getContext()));
