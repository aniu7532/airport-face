...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public void showSuccessToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast toast = Toasty.success(Utils.getApp(), msg, Toast.LENGTH_LONG, true);
                toast.show();
            }
        });
    ...
    public void showInfoToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast toast = Toasty.info(Utils.getApp(), msg, Toast.LENGTH_LONG, true);
                toast.show();
            }
        });
    ...
    public void showWarningToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast toast = Toasty.warning(Utils.getApp(), msg, Toast.LENGTH_LONG, true);
                toast.show();
            }
        });
    }
    ...
    public void showErrorToast(final String msg) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast toast = Toasty.error(Utils.getApp(), msg, Toast.LENGTH_LONG, true);
                toast.show();
            }
        });
    }
    ...
    protected Snackbar showIndefiniteSnackBar(final View view, final String s, String action,
    ...
    private void enableSnackBarShowMultiLines(Snackbar snackbar, int maxLines) {
        final SnackbarContentLayout contentLayout =
                (SnackbarContentLayout) ((ViewGroup) snackbar.getView()).getChildAt(0);
    ...
    public void showNoticeDialog(String title, String content) {
        ...
        noticeDialog = new AlertDialog.Builder(this).setTitle(title).setMessage(content)
