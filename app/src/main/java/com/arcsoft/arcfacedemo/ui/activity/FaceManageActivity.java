...
public class FaceManageActivity extends BaseActivity
        implements FacePhotoAdapter.OnItemChangedListener, BaseActivity.OnGetImageFromAlbumCallback {
    ...
    private void initViewModel() {
        ...
        // 人脸库人数发生变更时，刷新View
        facePhotoViewModel.getTotalFaceCount().observe(FaceManageActivity.this,
                count -> binding.faceCountNotificationView.refreshTotalFaceCount(count));
    ...
    private void initView() {
        ...
        binding.fabAdd.setOnClickListener(v -> {
            AlertDialog addFacesDialog = new AlertDialog.Builder(FaceManageActivity.this)
                    .setTitle(R.string.label_face_manage).setNegativeButton(R.string.cancel, null)
        ...
        ColorStateList grayColorStateList =
                new ColorStateList(new int[][] { { Color.GRAY } }, new int[] { Color.GRAY });
    ...
    public void onGetImageFromAlbumSuccess(Uri uri) {
        Bitmap bitmap =
                ImageUtil.uriToScaledBitmap(this, uri, ImageUtil.DEFAULT_MAX_WIDTH, ImageUtil.DEFAULT_MAX_HEIGHT);
        if (bitmap != null) {
            ...
            facePhotoViewModel.registerFace(bitmap, (facePreviewInfo, success) -> {
                showLongSnackBar(binding.fabAdd,
                        getString(success ? R.string.register_success : R.string.register_failed));
            });
        } else {
    ...
    public void registerFromFile(File dir) {
        ...
        Snackbar snackbar = showIndefiniteSnackBar(binding.fabAdd, getString(R.string.registering_please_wait),
