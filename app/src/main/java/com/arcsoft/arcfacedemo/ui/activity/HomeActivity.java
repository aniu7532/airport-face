...
public class HomeActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initViewModel() {
        homeViewModel = new ViewModelProvider(getViewModelStore(),
                new ViewModelProvider.AndroidViewModelFactory(getApplication())).get(HomeViewModel.class);

        // 设置监听，在数据变更时，更新View中内容
        homeViewModel.getActivated().observe(this, activated -> activeView
                .changeTipHint(getString(activated ? R.string.already_activated : R.string.not_activated)));
        ...
        homeViewModel.getActiveCode().observe(this, activeCode -> {
            ...
            case ErrorInfo.MERR_ASF_ALREADY_ACTIVATED:
                ...
                break;
            default:
                notification = getString(R.string.active_failed, activeCode,
                        ErrorCodeUtil.arcFaceErrorCodeToFieldName(activeCode));
                break;
            }
    ...
    private void initView() {
        ...
        // activityHomeBinding.llRootView.addView(new NavigateItemView(this, R.drawable.ic_face_id_ir,
        // getString(R.string.page_ir_face_recognize), RegisterAndRecognizeActivity.class));
        // activityHomeBinding.llRootView.addView(new NavigateItemView(this, R.drawable.ic_liveness_check,
        // getString(R.string.page_liveness_detect), LivenessDetectJinActivity.class));
        // activityHomeBinding.llRootView.addView(new NavigateItemView(this, R.drawable.ic_face_attr,
        ...
        activeView = new NavigateItemView(this, R.drawable.ic_online_active, getString(R.string.active_engine), "",
                ActivationActivity.class);
        activityHomeBinding.llRootView.addView(activeView);

        // activityHomeBinding.llRootView.addView(new NavigateItemView(this, R.drawable.ic_readme,
        // getString(R.string.page_readme), ReadmeActivity.class));
                ...
                public void onRefuse(boolean refuse) {
                    if (refuse) {
                        ...
                        if (checkPermissions(NEEDED_PERMISSIONS)) {
                            ...
                            ActivityCompat.requestPermissions(HomeActivity.this, NEEDED_PERMISSIONS,
