...
//
//@Entity
//public class TemporaryCardRecords extends Records implements Serializable {
...
//    public long parentId;// false引领人通行记录id
...
//
//
//    @Generated(hash = 1688023027)
//    public TemporaryCardRecords() {
//    }
//
//
//    @Generated(hash = 981249451)
//    public TemporaryCardRecords(Long id, String cardId, String idCode,
//            String applyId, String direction, String deviceId, String deviceName,
...
//            long parentId, String leadingPeopleId, String sitePhoto,
//            String checkTime) {
//        this.id = id;
//        this.cardId = cardId;
//        this.idCode = idCode;
