...
public class FaceEntity implements Parcelable {
    ...
    // }
    // FaceEntity that = (FaceEntity) o;
    // return faceId == that.faceId && registerTime == that.registerTime && userName.equals(that.userName)
    // && imagePath.equals(that.imagePath) && Arrays.equals(featureData, that.featureData);
    // }
