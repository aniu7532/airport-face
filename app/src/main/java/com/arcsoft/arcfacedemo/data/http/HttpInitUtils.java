...
public class HttpInitUtils {
    ...
    public static void init(@NonNull Application context, long time) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            // log相关
            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor(ArcFaceApplication.TAG);
        ...
        builder.sslSocketFactory(unsafeClient.getSocketFactory(), unsafeClient.getTrustManager());
